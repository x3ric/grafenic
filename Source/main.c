...
int main(void)
{
    ...
    //Image myImage = LoadImage("./Resources/Arch.png");
    Font myFont = LoadFont("./Resources/Monocraft.ttf");
    Texture img1 = LoadTexture("./Resources/box1.png");
    Texture img2 = LoadTexture("./Resources/Arch.png");
